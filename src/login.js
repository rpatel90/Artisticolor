...
fb.Auth.onAuthStateChanged(fb.auth, (user) => {
    if(user) { 
        ...
        fb.Auth.updateProfile(user, { photoURL: 'http://127.0.0.1:5500/icons/usercon.png' });
        ...
        document.getElementById('login').addEventListener('click', (e) => {
            ...
            fb.Auth.signInWithEmailAndPassword(fb.auth, email.value, password.value).then((userCredential) => {
